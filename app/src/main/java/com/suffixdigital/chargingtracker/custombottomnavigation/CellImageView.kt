    ...
    private fun setAttributeFromXml(context: Context, attrs: AttributeSet) {
        ...
        try {
            a.apply {
                ...
                resource =
                    getResourceId(R.styleable.CellImageView_icon_imageview_resource, resource)
                ...
                actionBackgroundAlpha = getBoolean(
                    R.styleable.CellImageView_icon_imageview_actionBackgroundAlpha,
                    actionBackgroundAlpha
                )
                changeSize =
                    getBoolean(R.styleable.CellImageView_icon_imageview_changeSize, changeSize)
